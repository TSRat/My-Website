...
- Maintained source: `static-sites/melromarc-sisters/`
...
`build:melromarc` invokes `scripts/build-maintainable-site.mjs`:
...
remain documented in `web/sites/melromarc-sisters/site-manifest.proposed.json`
and protected by targeted tests.
...
- Authoritative assets: `static-sites/melromarc-sisters/public/`
