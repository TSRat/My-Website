...
- **Major routes and navigation:** One 52-screen route with eight stable chapter anchors, beginner primer, name lens, route map, expanded Tlaxcala and Cholula explanations, Spanish background, occupation / siege sequence, evidence annotations, translation split, reflection, sources, Data boundary, and a complete `001–004` series footer.
- **Current visual direction:** Fifty-two deliberately varied editorial compositions: cut-out poster, archival walls, Iberian portrait field, expedition ledger, route console, translation seam, lake-war stills, cartographic table, red rupture, and direct two-part video theater.
...
- **Content/data model:** 21-page manuscript, two subtitle transcripts, Own Map files, eight credited public-domain archive images, thirteen locally optimized creator-library images / motifs with visible qualification, and two direct Bilibili embeds; the site labels fact, interpretation, framing, and metaphor separately.
...
- **Tests / CI:** Site structure and 41-screen readiness tests plus Pages asset validation. Codex browser smoke covers the creator’s 1782 × 864 screenshot size plus desktop and narrow viewports; Antigravity extended QA remains pending.
...
- **Figma URL:** [La Malinche v4 Spain + siege catalogue](https://www.figma.com/design/oSIKdvkSLayRe2BBAyuDoi?node-id=14-2).
