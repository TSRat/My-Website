...
- **Major routes and navigation:** One 41-screen route with eight stable chapter anchors, beginner primer, name lens, route map, two-screen Tlaxcala and Cholula explanations, three-screen Spanish background, six-screen occupation / siege sequence, evidence annotations, translation split, reflection, sources, and Data boundary.
- **Current visual direction:** Forty-one deliberately varied editorial compositions: cut-out poster, archival walls, Iberian portrait field, expedition ledger, route console, translation seam, lake-war stills, cartographic table, red rupture, and direct two-part video theater.
