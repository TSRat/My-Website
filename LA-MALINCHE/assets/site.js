(() => {
  ...
  const lensContent = {
    all: {
      color: "#d7ad64",
      copy: "三个名字同时保留：出生世界、殖民秩序与后世记忆，先后在同一个人身上留下名称。",
    },
    malintzin: {
      color: "#96c59c",
  ...
  const mapStages = {
    route: {
      ...
      title: "奥卢特拉 → 希卡兰戈 → 波顿查恩",
      alt: "从奥卢特拉经希卡兰戈到波顿查恩的迁移路线示意图",
      copy: "她可能先被带到重要贸易节点希卡兰戈，后来又进入玛雅语世界的波顿查恩。地理位移同时切断了亲族、身份与原有语言环境。",
    },
    oluta: {
      src: "./assets/maps/oluta.webp",
      title: "奥卢特拉 · 可能的出生地",
      alt: "马琳切可能出生的奥卢特拉区域位置示意图",
      copy: "原稿把她的出生地放在墨西哥湾沿岸的奥卢特拉附近。具体地点与出生时间并不确定。",
    },
    xicalango: {
