            ...
            <article className="long-story" id={`story-${index + 1}`} key={story.title}>
              ...
              <div className="story-content-grid">
                <div className="story-prose">
                  <section>
                    <h3>背景</h3>
                    <p>{story.background ?? story.summary}</p>
                  </section>
                  <section>
                    <h3>事件</h3>
                    <p>{story.happened}</p>
                  ...
                  <a className="story-source-link" href={story.sourceUrl} rel="noreferrer" target="_blank">
                    查看原文：{story.sourceName} <span aria-hidden="true">↗</span>
                  </a>
                  <small className="story-source-date">{story.sourceDate}</small>
                </div>
              </div>
