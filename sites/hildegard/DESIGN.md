...
- The right rail contains nine chapter-name anchors. The only reading-position number is the global counter at the top right; inline folio labels and the bottom previous / next strip are intentionally absent.
...
- The portal, epistolary prologue, music, language and afterlife pages use creator-selected images. Afterlife 2/2 now uses the square Hildegard avatar supplied for this correction.
...
- The epistolary prologue establishes a single hierarchy: concise title and context with the Frederick portrait at left, and the letter quotation as the dominant reading surface at right.
...
- Interaction script: `sites/hildegard/assets/hildegard-refresh.js`
- Figma handoff: `sites/hildegard/design/figma-handoff.md`
