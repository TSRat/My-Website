...
- With JavaScript: the chapter-name rail, one page number at the top-right of each folio and the mobile menu are active. Chapter leaves do not inject bottom previous / next controls.
