...
- With JavaScript: the chapter-name rail, one page number at the top-right of each folio, the synchronized top-right header counter and the mobile menu are active. Chapter leaves do not inject bottom previous / next controls.
