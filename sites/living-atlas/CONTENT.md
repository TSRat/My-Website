...
- 桌面与移动目录中的小红书入口指向创作者提供的个人主页；原公众号占位入口已按创作者要求删除。
- `07 Sites` 的马琳切卡片使用 `assets/malinche-cover-vol-1.webp`。它从创作者指定的 `Women Story/Malinche/封面7.png` 等比缩放为 960 × 540 WebP，以降低主页缩略图加载量；没有改动画面内容。
- 这张封面是创作者制作的项目视觉，不作为马琳切的历史肖像或现场证据；替代文本按“创作者制作的封面”描述其角色。
